...
class SimpleDictionarySpec extends ObjectBehavior
{
    ...
    {
        $this->beConstructedWith('foo', array('foo', 'bar', 'baz'), array(0, 1, 2));
    ...
    {
        $this->beConstructedWith('foo', array('foo', 'bar', 'baz'), array(0, 1, 2, 3));
    ...
    {
        $this->beConstructedWith('foo', array('foo', 'bar', 'bar'), array(0, 1, 2));
